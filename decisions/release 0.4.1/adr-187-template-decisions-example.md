...
|---|---|---|---|---|---|---|---|---|---|
| 1 | Requirements | BA |  |  |  | To Do | 05-06-2026 | 05-06-2026 | No new SRS items are added by this ADR; the example demonstrates the existing decision-record requirements (SRS-039, SRS-052). Formal SRS coverage of the `create` command's template contents is tracked separately (see Out of Scope). |
